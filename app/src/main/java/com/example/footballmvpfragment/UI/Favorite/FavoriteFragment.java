...
import com.example.footballmvpfragment.UI.Teams.TeamAdapter;
...
public class FavoriteFragment extends Fragment implements FavoriteContract.View {
    ...
    @Override
    public void showDataList(List<TeamsItem> teamsItemsList) {
        rvFavorite.setLayoutManager(new LinearLayoutManager(getContext()));
        rvFavorite.setAdapter(new TeamAdapter(getContext(), teamsItemsList));
